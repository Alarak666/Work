...
namespace ERPGE.Blazor.Server {
    public partial class ERPGEBlazorApplication : BlazorApplication {
        public ERPGEBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ERPGEBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
